...
# Only apply to content/aulas/*/slides/*.html
if [[ "$FILE_PATH" != *"content/aulas/"*"/slides/"* ]] || [[ "$FILE_PATH" != *.html ]]; then
    exit 0
fi
...
echo "Ler evidence-db.md antes de editar slides. Caminho: content/aulas/$AULA/references/evidence-db.md" >&2
exit 2
