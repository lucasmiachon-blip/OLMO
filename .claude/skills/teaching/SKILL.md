...
Auxilia na preparacao de aulas, material didatico e melhoria continua como professor.
...
- **Experiencia**: usar casos clinicos reais como base
...
- Frank Harrell: fharrell.com | Andrew Gelman: statmodeling.stat.columbia.edu
- StatQuest YouTube | EQUATOR Network

### MBE
- CEBM Oxford | Cochrane Library
- Dr. Luis Correia (medicinabaseadaemevidencias.blogspot.com) | The Bottom Line

### Ensino e Apresentacoes
- Garr Reynolds | Nancy Duarte | Michael Alley (assertion-evidence.com)
- Make It Stick (Brown, Roediger, McDaniel) | retrievalpractice.org
