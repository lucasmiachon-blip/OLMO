...
description: "Structured backlog management — add, triage, close, score, report. Interactive CRUD for .claude/BACKLOG.md with auto-scoring by staleness, dependency, and alignment. Use when user says /backlog, 'triage backlog', 'add to backlog', 'backlog report', 'what's stale in backlog', or manages project debt."
version: 1.0.0
---

# Backlog — Structured Project Debt Management

> .claude/BACKLOG.md is the single source of truth. This skill reads and writes it.
...
1. Read .claude/BACKLOG.md, find the highest `#` number
...
1. Read .claude/BACKLOG.md completely
...
1. Read .claude/BACKLOG.md + HANDOFF.md
...
- If .claude/BACKLOG.md format changes, adapt — the table structure is the contract, not the exact markdown.
