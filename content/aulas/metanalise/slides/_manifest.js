...
export const slides = [
  ...
  { id: 's-quality',      file: '05-quality.html',      phase: 'F2', headline: 'Qualidade, Risco de Viés e Certeza: três perguntas distintas, não hierarquia',                                                                                            timing: 90,   clickReveals: 3, customAnim: 's-quality',      narrativeRole: 'setup',      tensionLevel: 2, narrativeCritical: false, evidence: 's-quality-grade-rob.html' },
  ...
  { id: 's-forest1',      file: '08a-forest1.html',     phase: 'F2', headline: 'Forest Plot 1 — Li et al. 2026',                                                                                        timing: 90,   clickReveals: 0, customAnim: 's-forest1',     narrativeRole: 'setup',      tensionLevel: 2, narrativeCritical: false, evidence: 's-forest-plot-final.html' },
  { id: 's-forest2',      file: '08b-forest2.html',     phase: 'F2', headline: 'Forest Plot 2 — Ebrahimi et al. 2025',                                                                                  timing: 90,   clickReveals: 3, customAnim: 's-forest2',     narrativeRole: 'payoff',     tensionLevel: 2, narrativeCritical: false, evidence: 's-forest-plot-final.html' },
