...
export const slides = [
  ...
  { id: 's-importancia',  file: '02-importancia.html',  phase: 'F1', archetype: 'cards',       headline: 'Porque isso importa — Metodologia',                                                                                    timing: 60,   clickReveals: 0, customAnim: 's-importancia',      narrativeRole: 'setup',      tensionLevel: 1, narrativeCritical: false, evidence: 's-importancia.html' },
  ...
  { id: 's-contrato',     file: '02-contrato.html',     phase: 'F2', archetype: 'cards',      headline: '3 perguntas que você faz a toda meta-análise',                                            timing: 45,   clickReveals: 0, customAnim: 's-contrato',             narrativeRole: 'setup',      tensionLevel: 1, narrativeCritical: false },
  { id: 's-pico',         file: '04-pico.html',         phase: 'F2', archetype: 'cards',      headline: 'O valor da MA depende em grande parte da concordância entre o study PICO e o seu target PICO', timing: 60, clickReveals: 1, customAnim: 's-pico', narrativeRole: 'setup', tensionLevel: 2, narrativeCritical: false },
  ...
  { id: 's-ancora',       file: '13-ancora.html',       phase: 'F3', archetype: 'hero-stat',  headline: 'Clopidogrel reduziu eventos CV vs aspirina — 7 RCTs e 28.982 pacientes com dados individuais',                       timing: 90,   clickReveals: 0, customAnim: null,             narrativeRole: 'setup',      tensionLevel: 2, narrativeCritical: false, evidence: 's-ancora.html' },
