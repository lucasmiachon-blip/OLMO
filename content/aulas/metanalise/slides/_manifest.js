 ...
 * Atualizado: 2026-04-09 — 16 slides (S136: removidos s-abstract, s-grade, s-aplicacao; archetype field removido)
 */
...
export const slides = [
  ...
  { id: 's-importancia',  file: '02-importancia.html',  phase: 'F1', headline: 'Porque é importante: metodologia',                                                                                    timing: 60,   clickReveals: 0, customAnim: 's-importancia',      narrativeRole: 'setup',      tensionLevel: 1, narrativeCritical: false, evidence: 's-importancia.html' },
  ...
  { id: 's-contrato',     file: '02-contrato.html',     phase: 'F2', headline: '3 perguntas que você faz a toda meta-análise',                                            timing: 45,   clickReveals: 0, customAnim: 's-contrato',             narrativeRole: 'setup',      tensionLevel: 1, narrativeCritical: false },
