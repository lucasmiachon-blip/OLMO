...
> **S274 (tipos-ma evidence build, DONE):** Pipeline 7 pernas dispatch (3/7 emit). Novo evidence file `pre-reading-tipos-ma.html` criado (~600 li, formato canonical pre-reading-* style, 9 tipos MA — Pairwise/NMA/IPD/DTA/Prevalence/Dose-response/Bayesian/Living/Umbrella + 3 abordagens transversais, 30+ PMIDs verified com convenção V (azul, verified) / C (vermelho, candidate) badges). Sources: NLM (44.7KB) + Codex effort=medium (9 findings JSON `.claude/.research-tmp/codex-R-tipos-ma-S274.json`) + Evidence-Researcher Opus async (16/16 S187 PMIDs verified via WebFetch fallback + 9 novas refs 2024-2026: Veroniki PRISMA-NMA 2025, Mazzinari Bayesian IPD-MA 2025, Ying wCCA 2025, Nevill 168 LSRs, Butler LSR cost, Iannizzi LSR guidance, Crippa one-stage/continuous, Kirvalidze CCA pairwise). Pipeline failures registrados (Gemini.mjs timeout 60s, Perplexity Cloudflare 60s, D-lite 400, PubMed MCP HTTP 400). s-tipos-ma.html S187 (524 li, 16 PMIDs) preservado intacto — Lucas decide later: keep/merge/substitute. **Próxima Lane A (S275): criar slide `s-tipos-ma`** — 5 decisões Lucas (posição F2, filename, clickReveals, customAnim, evidence link) — ver root `HANDOFF.md §0 ⭐ Tarefa 1`. Plan: `.claude/plans/scalable-questing-crane.md`.
